...
// g++ -O3 src/approx/random_search/random_search.cpp -o bin/random_search -Iinclude -lstdc++fs && ./bin/random_search
...
// ./bin/random_search 4 1 3 3 1 10.0 TanH input/teach.nse input/test.nse output/mc_network.neetwook

// g++ -O3 src/approx/random_search/random_search.cpp -o bin/random_search -Iinclude -lstdc++fs && ./bin/multistart_cutoff 4 1 3 3 1 10.0 TanH input/train.nse input/test.nse output/mc_network.neetwook

int main(int argc, char** argv) {
	
	// This example demonstrates performance testing of the random_search algorithm.
	// 
